...
public interface GroupClientInterface {
     ...
     *
     */
    public UserToken getToken(final String username, final byte[] privatekey, String file_key_path);

    /**
     * Gets the current groupKey
     *
     * @param groupname The name of the group to get key
     * @param token     The token of the user requesting the key
     *
     * @return true if the new group was created, false otherwise
     *
     */
    public boolean getKey(final String groupname, final UserToken token);
