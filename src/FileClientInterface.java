...
public interface FileClientInterface {
   ...
   // public boolean challenge(String fpub, String username, byte[] user_pri_key);
     ...
     *
     */
    public boolean upload(final String sourceFile, final String destFile, final String group, final UserToken token, byte[] key, int n_key);
     ...
     *
     */
    public boolean download(final String sourceFile, final String destFile, final UserToken token, byte[] key, int n_key);
